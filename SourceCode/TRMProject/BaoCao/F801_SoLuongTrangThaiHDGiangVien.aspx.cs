...
public partial class BaoCao_F801_SoLuongTrangThaiHDGiangVien : System.Web.UI.Page
{
    ...
    #region Members
    US_RPT_BAO_CAO_SO_LUONG_TRANG_THAI_HD_GIANG_VIEN m_us_rpt_bao_cao_so_luong_trang_thai_hd_gv = new US_RPT_BAO_CAO_SO_LUONG_TRANG_THAI_HD_GIANG_VIEN();
    DS_RPT_BAO_CAO_SO_LUONG_TRANG_THAI_HD_GIANG_VIEN m_ds_rpt_bao_cao_so_luong_trang_thai_hd_gv = new DS_RPT_BAO_CAO_SO_LUONG_TRANG_THAI_HD_GIANG_VIEN();
    #endregion

    #region Private Methods
    private void load_data_2_grid()
    {
        m_us_rpt_bao_cao_so_luong_trang_thai_hd_gv.bao_cao_thong_ke_hd_giang_vien(m_ds_rpt_bao_cao_so_luong_trang_thai_hd_gv,m_cbo_edutop_or_elc.SelectedValue,CIPConvert.ToDecimal(m_cbo_thang_tinh_toan.SelectedValue),CIPConvert.ToDecimal(m_cbo_nam_tinh_toan.SelectedValue));
        m_grv_danh_sach_du_toan.DataSource = m_ds_rpt_bao_cao_so_luong_trang_thai_hd_gv.RPT_BAO_CAO_SO_LUONG_TRANG_THAI_HD_GIANG_VIEN;
    ...
    private void loadDSExprort(ref string strTable)
    {
        ...
        foreach (DataRow grv in this.m_ds_rpt_bao_cao_so_luong_trang_thai_hd_gv.RPT_BAO_CAO_SO_LUONG_TRANG_THAI_HD_GIANG_VIEN.Rows)
        {
            strTable += "\n<tr>";
            strTable += "\n<td style='width:12%;' class='cssTitleReport' nowrap='nowrap'>" + "<span style='font-family:Tahoma; font-size:0.9em'>" + ++v_i_so_thu_tu + "</td>";
            strTable += "\n<td style='width:12%;' class='cssTitleReport' nowrap='nowrap'>" + "<span style='font-family:Tahoma; font-size:0.9em'>" + grv[RPT_BAO_CAO_SO_LUONG_TRANG_THAI_HD_GIANG_VIEN.DON_VI_QUAN_LY] + "</td>";
            strTable += "\n<td style='width:12%;' class='cssTitleReport' nowrap='nowrap'>" + "<span style='font-family:Tahoma; font-size:0.9em'>" + grv[RPT_BAO_CAO_SO_LUONG_TRANG_THAI_HD_GIANG_VIEN.TRANG_THAI_HOP_DONG] + "</td>";
    ...
    private void loadTieuDe(ref string strTable)
    {
        ...
        strTable += "\n<tr>";
        strTable += "\n<td colspan='6' align='center'><class='cssTableView' style='width: 100%;  height: 40px; font-size: large; color:White; background-color:#810C15;' nowrap='wrap'><span style='font-family:Times New Roman; font-weight:bold; font-size:1.3em;'>TRM801 - BÁO CÁO THỐNG KÊ SỐ HỢP ĐỒNG THEO TRẠNG THÁI HỢP ĐỒNG" + "</td>";
        strTable += "\n</tr>";
        //
        strTable += "\n<tr>";
    ...
    protected void m_cmd_xuat_excel_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string strNamFile = "BaoCaoThongKeSoHDTheoTrangThaiHD" + DateTime.Now.Day + "-" + DateTime.Now.Month + "-" + DateTime.Now.Year + ".xls";
