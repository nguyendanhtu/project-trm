<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="F408_XacNhanToanBoNganHang.aspx.cs" Inherits="ChucNang_F408_XacNhanToanBoNganHang" %>
    ...
    <tr>
		<td class="cssPageTitleBG">
		    <asp:label id="m_lbl_thong_tin_hd" runat="server" CssClass="cssPageTitle" 
                Text="Xác nhận toàn bộ ngân hàng các thanh toán trong đợt thanh toán"/>
		</td>
	</tr>
    <tr>
		<td>
